...
const Sign_Up = () => {
    ...
    const register = async (e) => {
        ...
        if (json.authtoken) {
            ...
            if (json.errors) {
                setShowerr(json.errors);  // Az egész tömb, nem csak egy hiba
            } else {
                ...
                <div className="signup-form">
                    <form method="POST" onSubmit={register}>
                        ...
                        <div className="form-group">
                            ...
                            <input value={name} onChange={(e) => setName(e.target.value)} type="text" name="name" id="name" className="form-control" placeholder="Enter your name" aria-describedby="helpId" required />
                        </div>
                        ...
                        {showerr && Array.isArray(showerr) 
                                ? showerr.map((error, idx) => (
                                    <div key={idx} className="err" style={{ color: 'red' }}>
                                        {error.msg}
                                    </div>
                                ))
